...
export const getCategories = (store) => {
  if (isEmpty(store.getters["category/getCategories"])) {
...
export const getClientCodes = (store) => {
  if (isEmpty(store.getters["codes/getCodes"])) {
...
export const getThingsList = (store) => {
  if (isEmpty(store.getters["thingsList/getThingsList"])) {
...
export const getShopsList = (store) => {
  if (isEmpty(store.getters["shopsList/getShopsList"])) {
...
export const getDeliveryMethodsList = (store) => {
  if (isEmpty(store.getters["deliveryMethods/getDeliveryMethodsList"])) {
...
export const getCities = (store) => {
  if (isEmpty(store.getters["cities/getCities"])) {
...
export const getTransports = (store) => {
  if (isEmpty(store.getters["transport/getTransports"])) {
...
export const getTransporters = (store) => {
  if (isEmpty(store.getters["transporter/getTransporters"])) {
...
export const getStorehouseTableData = (store) => {
  if (isEmpty(store.getters["storehouse/getStorehouseData"])) {
...
export const getFaxes = (store) => {
  if (isEmpty(store.getters["faxes/getFaxes"])) {
